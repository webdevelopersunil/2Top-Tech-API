...
class ProviderController extends Controller
{
    ...
    {
        $auth_user = authSession();
        $providerdata = Provider::with('user', 'providerPatymentMethod', 'states','services.service', 'documents')->where('id',$id)->first();
    ...
    public function changeProviderStatus($id, $status)
    {
        ...
        if($data && $emailTemplate){
            ...
            (new FCMPushNotificationService)->changeProviderStatus($provider->user->id, $theUpdatedData->status);
        }
