    ...
    public function login(){
        ...
        if(Auth::attempt(['email' => request('email'), 'password' => request('password')])){
            ...
            if($roleDetail->roleDetail->name=='restaurant'){
                ...
                $subscription       =   SubscriptionPlan::where('company_id',$profile->id)->first('subscription_type');
            ...
            if($roleDetail->roleDetail->name=='restaurant'){
                $success['subscription_status'] = $subscription_status == 'pending' ? False : True;
                $success['subscription_type'] = isset($subscription->subscription_type) ? $subscription->subscription_type : null;
            }
