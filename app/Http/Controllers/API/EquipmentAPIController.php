...
class EquipmentAPIController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $query = Equipment::query()->latest()->where('company_id',$company->id)->with('frequency')->with('file','category');
        ...
        return common_response( 'Equipment retrieved successfully', True, 200, $query->paginate(10) );
    }
